...
import com.bs.hjsyxt.app.HjsyxtApplication;
...
public class LogUtils {
    ...
    public static void init(Context context) { // 在Application中初始化
        LOG_FILE_PATH = Environment.getExternalStorageDirectory().getPath() + File.separator + HjsyxtApplication.getsInstance().getPackageName();
        LOG_FILE_NAME = "Log";
    }
